layui.use(['element', 'laydate', 'table', 'layer'], function () {
    ...
    table.on('tool(table)', function (obj) {
        ...
        if ($(".layui-tab-title li").length == 1) {
            ...
            $(".layui-tab-item").eq(1).html('<iframe data-frameid="view" scrolling="auto" frameborder="0" src="privateroom2.html?game=' + obj.data.gameid + '&date=' + obj.data.date + '" id="sunIframe"></iframe>');
        }
    ...
    var active = {
        ...
        tabAdd: function (obj) {
            ...
            element.tabAdd('demo', {
                title: '私人房详情',
                content: '<iframe data-frameid="view" scrolling="auto" frameborder="0" src="privateroom2.html?game=' + obj.data.gameid + '&date=' + obj.data.date + '" id="sunIframe"></iframe>',
                id: 'view' //规定好的id
            })
        },
        // 切换到指定Tab项
