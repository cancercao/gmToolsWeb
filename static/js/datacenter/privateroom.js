layui.use(['element', 'laydate', 'table', 'layer'], function () {
    ...
    $('#gameid').change(function () {
        ...
        switch (gameid) {
            ...
            case 'qjhh':
                ...
                break;
            case 'tmhh':
                game.append("<option value='Value'>天门晃晃</option>");
                game.append("<option value='Value'>天门硬晃</option>");
                break;
            case 'hchh':
                game.append("<option value='Value'>汉川晃晃</option>");
            ...
            success: function (data) {
                table.render({
                    ...
                    cols: [[
                        ...
                        { field: 'adduser', align: 'center', title: '新增用户' },
                        ...
                        { field: 'fangka', align: 'center', title: '房卡日消耗' },
                        { field: 'zonggong', align: 'center', title: '总局数' },
                        { field: 'renjun', align: 'center', title: '人均局数' },
                        { field: 'renjunshichang', align: 'center', title: '人均游戏时长（分）' },
                        { field: 'xinzengrenjunjushu', align: 'center', title: '新增人均局数' },
                        { field: 'xinzengrenjunyouxishichang', align: 'center', title: '新增人均游戏时长（分）' },
                        { field: 'sirenfanghejinbifang', align: 'center', title: '私人房和金币场DAU人数比' },
    ...
    $('#searchDate').click(function () {
     ...
     table.on('tool(table)', function (obj) {
        ...
        if ($(".layui-tab-title li").length == 1) {
            ...
            $(".layui-tab-item").eq(1).html('<iframe data-frameid="view" scrolling="auto" frameborder="0" src="privateroom2.html?gid=' + obj.data.gameid + '&date=' + obj.data.date + '&gtype=' + $('#gtype').val() + '" id="sunIframe"></iframe>');
        }
    ...
    var active = {
        ...
        tabAdd: function (obj) {
            ...
            element.tabAdd('demo', {
                title: '私人房详情',
                content: '<iframe data-frameid="view" scrolling="auto" frameborder="0" src="privateroom2.html?gid=' + obj.data.gameid + '&date=' + obj.data.date + '&gtype=' + $('#gtype').val()  + '" id="sunIframe"></iframe>',
                id: 'view' //规定好的id
            })
        },
        // 切换到指定Tab项
